...
student_data = {}
data_path = "../Quantified-Student/POCs/DocumentParsingPOC/downloads"
...
def parse_docx(file):
    ...
    for para in parsed.paragraphs:
        text = remove_whitespace_and_punct(para.text)
        text = remove_stopwords(text)
        fulltext.append(text.encode().decode("utf-8", "replace"))  # TODO check how functional this is
