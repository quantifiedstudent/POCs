...
$message_jwt = [
    "iss" => 'http://localhost/lti/src/web',
    ...
    "https://purl.imsglobal.org/spec/lti-nrps/claim/namesroleservice" => [
        "context_memberships_url" => "http://localhost/lti/src/web/platform/services/nrps",
    ...
    "https://purl.imsglobal.org/spec/lti-ags/claim/endpoint" => [
        ...
        "lineitems" => "http://localhost/lti/src/web/platform/services/ags/lineitems.php",
    ]
];
