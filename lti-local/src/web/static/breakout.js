...
var submitScore = function() {
    ...
    xhttp.open("GET", "/lti/src/web/api/score.php?launch_id=" + launch_id + "&score=" + window.score + "&time=" + time_taken, false);
    xhttp.send();
}
...
var getScoreBoard = function() {
    ...
    xhttp.open("GET", "/lti/src/web/api/scoreboard.php?launch_id=" + launch_id, true);
    xhttp.send();
}
